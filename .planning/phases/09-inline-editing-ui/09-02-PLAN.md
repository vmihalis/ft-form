...
must_haves:
  truths:
    - "All 18 form fields are editable inline in the detail panel"
...
Purpose: Enable admins to edit any of the 18 application fields directly from the detail panel.
...
<task type="auto">
  ...
  <action>
Update ApplicationSheet.tsx to use EditableField for all 18 editable fields.
...
**Note on linkedIn:** Currently has special link rendering. EditableField will handle this as a text value. Consider whether to keep link functionality in display mode (can be enhanced later, but basic text editing is the MVP).
...
3. All 18 fields converted: `grep -c "EditableField" src/components/admin/ApplicationSheet.tsx` should return 18+
4. TypeScript compiles: `npx tsc --noEmit`
  </verify>
  <done>
- All 18 form fields use EditableField component
...
<task type="checkpoint:human-verify" gate="blocking">
  <what-built>Inline editing for all 18 application fields in the admin detail panel</what-built>
  <how-to-verify>
...
1. **All fields editable:**
   - Count EditableField usages matches expected 18
...
<success_criteria>
- All 18 application fields are editable inline

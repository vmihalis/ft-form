...
must_haves:
  truths:
    ...
    - "Application tested on iOS and Android devices"
  artifacts:
    - path: "vercel.json"
...
@.planning/phases/07-mobile-optimization-deployment/07-01-SUMMARY.md
</context>
...
<task type="checkpoint:human-action" gate="blocking">
  <action>Configure production environment variables and deploy</action>
  <instructions>
    ...
    **Step 5: Verify Basic Deployment**
    ...
    **Step 6: Mobile Device Testing (DEPLOY-03)**
    Test on real iOS and Android devices to verify mobile optimization:

    **iOS Testing (Safari):**
    1. Open production URL on iPhone/iPad
    2. Test /apply form: tap through all form fields
    3. Verify: touch targets feel responsive (no mis-taps)
    4. Verify: keyboard scrolls focused input into view
    5. Verify: form submits successfully on mobile

    **Android Testing (Chrome):**
    1. Open production URL on Android phone/tablet
    2. Test /apply form: tap through all form fields
    3. Verify: touch targets feel responsive (no mis-taps)
    4. Verify: keyboard scrolls focused input into view
    5. Verify: form submits successfully on mobile

    **Admin Dashboard Mobile Test:**
    1. Open /admin on mobile device
    2. Verify: login works on mobile
    3. Verify: application list is scrollable
    4. Verify: status dropdown is usable with touch
  </instructions>
  <resume-signal>Provide the production URL and confirm "iOS tested" and "Android tested" after completing mobile device testing</resume-signal>
</task>
...
<task type="auto">
  ...
  <files></files>
  <action>
    After user provides production URL and confirms mobile testing, verify:
  ...
  <verify>
    ...
    User confirmed iOS and Android testing complete
  </verify>
  <done>
    Production deployment verified, accessible, and tested on iOS and Android
  </done>
</task>
...
7. Mobile testing completed on iOS device
8. Mobile testing completed on Android device
</verification>
...
- iOS mobile testing confirmed (touch targets, keyboard, submission)
- Android mobile testing confirmed (touch targets, keyboard, submission)
</success_criteria>
